...
if __name__ == "__main__":
    ...
    print("\t{0:20}{1:20}{2:25}{3:25}".format("KiloBytes", str(round(tamFilaKiloBytes,8)), str(round(tamFilaKiloBytes * filasPorHoja,8)), str(round(tamFilaKiloBytes * totalRegistros,8)) ))
    print("\t{0:20}{1:20}{2:25}{3:25}".format("MegaBytes", str(round(tamFilaMegaBytes,8)), str(round(tamFilaMegaBytes * filasPorHoja,8)), str(round(tamFilaMegaBytes * totalRegistros,8)) ))
    print("\t{0:20}{1:20}{2:25}{3:25}".format("GigaBytes", str(round(tamFilaGigaBytes,8)), str(round(tamFilaGigaBytes * filasPorHoja,8)), str(round(tamFilaGigaBytes * totalRegistros,8)) ))
    print("\n\n\t{0:26} {1:10}".format("Numero de Registros: ", str(round(totalRegistros,8)) ))
    print("\t{0:26} {1:10}".format("Numero de filas por hoja: ", str(round(filasPorHoja,8) )))
    print("\t{0:26} {1:10}".format("Numero de hojas: ", str(round(numHojas,8))))
    print("\n"*3)
